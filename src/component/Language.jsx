export const Language = () => {
    return (
        <section className="language section" id="language">
            <h2 className="section-title text-3xl font-bold text-center my-8" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1500">Language</h2>
