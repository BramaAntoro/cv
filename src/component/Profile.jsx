  ...
  return (
    <section id="home" className="home container px-14 mt-14 md:mt-5">
      <div className="flex items-center flex-col-reverse md:flex-row">
        <div data-aos="fade-right" className="w-full md:w-2/3 order-2 md:order-1">
        ...
        <div data-aos="fade-up" className="flex justify-center md:justify-end md:w-1/3 w-full order-1 md:order-2">
